...
--
-- Conversión MariaDB del esquema lógico original PostgreSQL.
-- Preparado para MariaDB 11.8+.
...
-- Validación del horario de intensivos.
DELIMITER $$
...
-- La función es útil para consultas del backend.
DELIMITER $$
...
VALUES ('Plan 3×', 3, 1000.00, TRUE), ('Plan 5×', 5, 1200.00, TRUE);
