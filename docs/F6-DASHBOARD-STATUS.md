...
- **Conversión:** cohorte de oportunidades creadas en el periodo que posteriormente alcanzan una inscripción completada por Sharky. Abrir un Flow, iniciar pago o enviar información no convierte. Una conversión posterior puede elevar la tasa de una cohorte histórica. El estado `CONVERTED` conserva el hecho histórico aunque el alumno asociado sea eliminado posteriormente.
