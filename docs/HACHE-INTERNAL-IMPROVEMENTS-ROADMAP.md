...
**Estado del roadmap:** Fase 1 **Implementada**; Fase 2 **Desplegado**; fases 3–9 **Pendientes**.  
...
| Pendientes y alertas | F1 implementó gestión persistente para tres causas iniciales; F2 incorporó saldo de intensivo pendiente reutilizando la misma cola y quedó desplegado con comprobación funcional representativa en producción. Las alertas derivadas existentes continúan siendo fuentes separadas. | [pendientes](../api/pendientes.php), [centro de pendientes](../config/centro-pendientes.php), [alertas](../api/alertas.php), [obligaciones-alumnos](../api/obligaciones-alumnos.php). | F1 gestiona atención; F2 aporta deuda desplegada; F4/F5 incorporan los tipos restantes sin duplicar la cola. |
