...
| 2026-09-18 | F8.4 Auditoría: cierres forward-only de huecos de escritura. | PR #343 edición de alumno; #344 cambio rápido de horario; #345 perfil de profesor; #346 retiro de intensivo; #347 invalidación de pago; #348 correcciones de asistencia con actor y before/after durable. PR #349 captura bajo bloqueo el before/after de las dos filas afectadas al ajustar un rango financiero. Sin backfill ni cambios de reglas de negocio. | **En implementación**: PR #343–#348 integrados y desplegados por su ciclo GitHub; #349 permanece sujeto a revisión/merge/deploy. Tras este hueco corresponde revalidar la matriz antes de F8.5. |
...
| F8 Auditoría | En implementación | Auditoría e historial existentes; D-29; F8.0–F8.3; micro-cobertura F8.4 forward-only | Completar/revalidar F8.4 tras PR #349 y, si no quedan huecos importantes demostrados, avanzar F8.5 regresiones/evidencia y F8.6 cierre documental sin marcar Verificado antes de evidencia real. |
