...
**Última base comprobada para esta actualización:** `main`, commit `6c0a298b57be4e958d67fd9723b0ced5deef0077`.  
**Estado del roadmap en esta actualización:** Fase 6 **Verificado**. Fase 7 **Desplegado**: F7.1–F7.6 están integrados y publicados; la primera verificación operacional read-only confirmó cobertura forward-only pero todavía no existen casos reales post-cobertura suficientes para marcar F7 **Verificado**.  
...
| F8 Auditoría | Desplegado | Auditoría e historial existentes; D-29; F8.0–F8.4 completos; F8.5 automatizado y desplegado en PR #350 | Obtener evidencia operativa real con sesión ADMIN y casos post-cobertura; después ejecutar F8.6 y marcar Verificado solo si esa comprobación cumple los criterios. |
