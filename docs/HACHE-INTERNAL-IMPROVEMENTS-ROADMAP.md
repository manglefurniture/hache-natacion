...
| 2026-09-17 | F6 P-06: sexto micro-incremento, cobertura forward-only y lectura backend reconciliable. | PR #321 en revisión; marcador `dashboard_prospectos_cobertura_desde`, lectura ADMIN por cohorte/sede/fuente, detalle sin PII/hashes y regresiones SQLite/MariaDB. | El incremento no hace backfill ni añade UI; la cobertura solo comienza cuando la migración llegue a producción. Quality, revisión automática, merge, deploy y verificación siguen siendo hitos separados. |
...
| F6 Dashboard | En implementación | Dashboard, tiempo operativo, F1/F2/F5, P-06 resuelta por D-18/D-19/D-20/D-21, lecturas puras, productor durable, sede estructurada, vínculo `COMPLETED` y exclusión de alumno existente desplegados | Completar Quality/revisión de PR #321 y, si el contrato backend queda integrado/desplegado/verificado, abordar la UI de prospectos/conversión en un micro-paso posterior; sin backfill. |
