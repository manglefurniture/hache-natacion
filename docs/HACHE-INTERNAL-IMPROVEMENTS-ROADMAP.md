...
**Estado:** En implementación. F7.1 y F7.2 están desplegados y verificados técnicamente: vigencia durable forward-only y sustituciones explícitas con conservación de anulaciones. Incidencias, carga realizada e historial/UI integrada continúan pendientes en micro-pasos posteriores.
...
| F7 Profesores | En implementación | Profesores, horarios, cancelaciones, D-23/D-24, F7.1 y F7.2 | F7.2 cerrado. Siguiente micro-paso: UI ADMIN mínima de sustituciones consumiendo la autoridad F7.2 sin recalcular reglas. |
