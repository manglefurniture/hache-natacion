...
| 2026-09-17 | F6 P-06: segundo micro-incremento, productor mínimo de oportunidades. | PR #312, rama `f6/p06-opportunity-producer`; parte exactamente de `41a38479...`; sin reutilizar PR #310 como base. | En revisión: abre solo el primer evento unmatched→prospect de forma idempotente; conversión, exclusión, enriquecimiento posterior y dashboard quedan fuera. |
