...
**Última base comprobada para esta actualización:** `main`, commit `c0213cc25122bf05ac32c63eb8955e4b2d9b6e7f`.  
**Estado del roadmap en esta actualización:** Fase 6 **Verificado**. Fase 7 **En implementación**: F7.1–F7.5 están desplegados y verificados técnicamente; el siguiente micro-paso es la verificación operativa dirigida de F7 con datos reales disponibles, sin fabricar escenarios.  
...
**Estado:** En implementación. F7.1–F7.5 están desplegados y verificados técnicamente. La lectura ADMIN de actividad por profesor y periodo combina vigencias, sesiones, incidencias y sustituciones sin escribir datos ni reconstruir historia; la UI integrada consume ese contrato sin recalcular autoridad. Permanece la verificación operativa dirigida de los casos del criterio de terminado antes de cerrar F7.
...
| F7 Profesores | En implementación | Profesores, horarios, cancelaciones, D-23–D-27 y F7.1–F7.5 | F7.5 cerrado. Siguiente micro-paso: verificación operativa dirigida de los casos exigidos por el criterio de terminado con datos reales disponibles, sin fabricar historia ni escenarios. |
