...
**Última base comprobada para esta actualización:** `main`, commit `2fa1b52e59f6c2a8bf73f722023b65bbcadd0af0`.  
**Estado del roadmap en esta actualización:** Fase 6 **Verificado**; el alcance funcional comprometido está integrado y desplegado, y la revisión operativa dirigida en producción con sesión ADMIN no reportó discrepancias. Los ajustes visuales móviles quedan separados del cierre funcional.  
...
**Estado:** En implementación. F7.1–F7.3 están desplegados y verificados técnicamente: vigencia durable, sustituciones explícitas y UI ADMIN mínima. La lectura integrada de actividad/carga e incidencias continúa pendiente en micro-pasos posteriores.
...
| F7 Profesores | En implementación | Profesores, horarios, cancelaciones, D-23–D-25 y F7.1–F7.3 | F7.3 cerrado. Siguiente micro-paso: lectura operativa integrada por profesor con fuentes/periodo y sin inventar carga realizada. |
