...
| F8 Auditoría | En análisis | Auditoría e historial existentes; D-29 y contrato F8 | Implementar F8.2 como lectura ADMIN read-only, empezando por `auditoria_eventos` e `historial` sin reconstruir before/after. |
