...
| 2026-09-18 | F8.4 Auditoría: cierres forward-only de huecos de escritura. | PR #343 edición de alumno; #344 cambio rápido de horario; #345 perfil de profesor; #346 retiro de intensivo; #347 invalidación de pago. PR #348 añade actor y before/after durable a correcciones de asistencia sin copiar observación libre. Sin backfill ni cambios de reglas de negocio. | **En implementación**: los micro-pasos integrados quedan desplegados por su ciclo GitHub; #348 permanece sujeto a revisión/merge/deploy. Siguiente hueco demostrado: rango de periodo financiero. |
...
| F8 Auditoría | En implementación | Auditoría e historial existentes; D-29; F8.0–F8.3; micro-cobertura F8.4 forward-only | Completar los huecos F8.4 demostrados (siguiente: rango de periodo financiero), luego F8.5 regresiones/evidencia y F8.6 cierre documental sin marcar Verificado antes de evidencia real. |
