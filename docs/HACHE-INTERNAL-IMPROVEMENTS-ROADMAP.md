...
| 2026-09-17 | F6 P-06: segundo micro-incremento, productor mínimo de oportunidades. | Rama `f6/p06-opportunity-producer`; parte exactamente de `41a38479...`; sin reutilizar PR #310 como base. | En implementación: abrir solo el primer evento unmatched→prospect de forma idempotente; conversión, exclusión, enriquecimiento posterior y dashboard quedan fuera. |
...
| F6 Dashboard | En implementación | Dashboard, tiempo operativo, F1/F2/F5, P-06 resuelta por D-18 y lecturas puras de alumnos/sesiones/intensivos/mensualidades/avisos | Completar en micro-pasos la implementación restante de prospectos/conversión; no publicar cobertura ni valores hasta que exista productor durable y vínculo verificable. |
