...
**Última base comprobada para esta actualización:** `main`, commit `6d9b6f0d023c71ccd239850f90bd10c62ab8f1af`.  
**Estado del roadmap en esta actualización:** Fase 6 **Verificado**. Fase 7 **En implementación**: F7.1–F7.4 están desplegados y verificados técnicamente; el siguiente micro-paso es la UI ADMIN integrada que consumirá la lectura F7.4 sin recalcular sus reglas.  
...
**Estado:** En implementación. F7.1–F7.4 están desplegados y verificados técnicamente. La lectura ADMIN de actividad por profesor y periodo combina vigencias, sesiones, incidencias y sustituciones sin escribir datos ni reconstruir historia; la UI integrada y la verificación operativa permanecen para micro-pasos posteriores.
...
| F7 Profesores | En implementación | Profesores, horarios, cancelaciones, D-23–D-26 y F7.1–F7.4 | F7.4 cerrado. Siguiente micro-paso: UI ADMIN integrada que consuma el contrato F7.4 sin recalcular carga ni autoridad; después, verificación operativa dirigida de F7. |
