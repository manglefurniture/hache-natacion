...
**Última base comprobada para esta actualización:** `main`, commit `626b1f608512b0d4a6b0a0c6f015d75295a7a78a`.  
**Estado del roadmap en esta actualización:** Fase 6 **Verificado**. Fase 7 **En implementación**: F7.1–F7.3 están desplegados/verificados técnicamente y F7.4 prepara una lectura operativa integrada de actividad docente, sin reconstruir carga histórica no acreditada.  
...
**Estado:** En implementación. F7.1–F7.3 están desplegados y verificados técnicamente. F7.4 implementa una lectura ADMIN de actividad por profesor y periodo que combina vigencias, sesiones, incidencias y sustituciones sin escribir datos ni reconstruir historia; la UI integrada y la verificación operativa permanecen para micro-pasos posteriores.
...
| 2026-09-18 | F7.4 Profesores: lectura backend integrada de actividad/carga. | Rama `f7/f7-4-professor-activity-read`; `config/profesor-actividad.php`, `api/profesor-actividad.php`, regresión MariaDB y Quality. Sin migración, UI ni cambios a Sharky. | **En revisión.** Distingue carga prevista, evidencia confirmada, no impartición y sesiones realizadas sin atribución; conserva fuentes, periodo, cobertura e historia sin reconstrucción ficticia. |
...
| F7 Profesores | En implementación | Profesores, horarios, cancelaciones, D-23–D-26 y F7.1–F7.4 | F7.4 en revisión: lectura backend integrada por profesor/periodo, con fuentes explícitas y carga realizada solo cuando la evidencia permite atribuirla. Siguiente micro-paso tras su cierre: UI ADMIN integrada y verificación operativa dirigida. |
