...
| F6 Dashboard | En implementación | Dashboard, tiempo operativo, F1/F2/F5, P-06 resuelta por D-18, lecturas puras y productor durable de oportunidades desplegado | Completar en micro-pasos el lifecycle/enriquecimiento y el vínculo verificable de conversión; no publicar prospectos/conversión hasta contar con cobertura suficiente. |
