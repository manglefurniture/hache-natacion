...
**Estado:** En implementación. F7.1 y F7.2 están desplegados y verificados técnicamente. F7.3 implementa una UI ADMIN mínima que consume esas autoridades sin recalcular reglas. Incidencias, carga realizada e historial integrado continúan pendientes en micro-pasos posteriores.
...
| F7 Profesores | En implementación | Profesores, horarios, cancelaciones, D-23–D-25, F7.1 y F7.2 | F7.3 en implementación: UI ADMIN mínima de sustituciones. |
