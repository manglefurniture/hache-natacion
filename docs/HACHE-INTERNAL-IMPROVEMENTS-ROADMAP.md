...
| 2026-09-18 | F8.5 Auditoría: regresión agregada del contrato. | `tests/f8-phase-evidence-regression.php` verifica before/after real y desconocido, actor, timestamp, entidad/referencia, technical vs confirmed, ADMIN-only, historial textual, no deduplicación heurística, no backfill y no ampliación de datos sensibles. | **En implementación**: queda sujeto a Quality/revisión/merge/deploy y luego evidencia real read-only en producción. |
...
| F8 Auditoría | En implementación | Auditoría e historial existentes; D-29; F8.0–F8.4 completos/desplegados | Completar F8.5 con regresión agregada y evidencia operativa real; después F8.6 cierre documental. No marcar Verificado antes de evidencia real en producción. |
