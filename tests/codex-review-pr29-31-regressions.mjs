...
assert.match(continuidad,/function continuidad_obligacion_de_relacion[\s\S]{0,900}str_contains\(\$observacion,'\[relacion:'\.\$relacionId\.'\]'\)[\s\S]{0,900}Continuidad desde intensivo:[\s\S]{0,450}\['plan_id'\][\s\S]{0,450}\['periodo_inicio'\]/,'la relación de continuidad debe tener trazabilidad propia y una migración legacy conservadora');
