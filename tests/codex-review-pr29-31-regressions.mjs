...
assert.match(continuidad,/programadoDesde>hache_fecha_operativa\(\)[\s\S]+continuidad_obligacion_de_relacion[\s\S]+continuidad_obligacion_intacta/,'la revocación futura debe ser idempotente, usar la fecha operativa y no tocar pagos ni historial');
