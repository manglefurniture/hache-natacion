...
assert.match(publicRegistration, /session_write_close\(\)[\s\S]*fastcgi_finish_request[\s\S]*hache_notificar_nueva_inscripcion/, 'el registro público debe liberar la sesión y entregar la respuesta antes de enviar el correo');
