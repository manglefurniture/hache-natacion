...
learning_ok(str_contains($service,"'actor'=>\$actor")&&str_contains($service,'HUMANO_HACHE'),'learning transcript must preserve USER/SHARKY/HUMANO_HACHE speaker identity');
