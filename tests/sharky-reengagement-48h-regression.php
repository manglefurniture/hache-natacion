...
reengagement_ok(str_contains($source,"hache_sharky_db_state_save_now(\$pdo,\$contact,\$state,172800)"),'El estado debe conservarse el tiempo suficiente para revalidar el mensaje de 48h.');
