...
reengagement_ok(str_contains($source,"if(\$stage===3)hache_sharky_db_state_save_now(\$pdo,\$contact,\$state,172800)"),'La etapa 3 debe refrescar el estado antes de diferirse por horario silencioso.');
