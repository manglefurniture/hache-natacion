...
$birthState=$x['state'];
eq(hache_sharky_orchestrator_parse_birthdate('07 febrero 1984'),'1984-02-07','Spanish month name birthdate is accepted');
eq(hache_sharky_orchestrator_parse_birthdate('7 de febrero de 1984'),'1984-02-07','natural Spanish birthdate with de is accepted');
eq(hache_sharky_orchestrator_parse_birthdate('07021984'),'1984-02-07','compact DDMMYYYY birthdate is accepted');
eq(hache_sharky_orchestrator_parse_birthdate('1984-02-07'),'1984-02-07','ISO birthdate remains accepted');
eq(hache_sharky_orchestrator_parse_birthdate('31021984'),null,'impossible compact birthdate remains invalid');
