...
ob_start(static function (string $html): string {
    ...
    foreach ([['/assets/backend-menu.css',$css,'</head>'],['/assets/backend-relief.css',$relief,'</head>'],['/assets/diagnostico.js',$diag,'</head>'],['/assets/backend-menu.js',$js,'</body>'],['/assets/obligaciones-alumnos.js',$oblig,'</body>'],['/assets/telefono-internacional.js',$phone,'</body>']] as [$needle,$tag,$close]) {
