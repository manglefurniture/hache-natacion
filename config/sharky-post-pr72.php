...
function hache_sharky_post72_whatsapp_style_policy(): string
{
    return implode("\n", [
        ...
        '- Si commercial_context.program ya es intensive, ese es el programa activo de la conversación hasta que el usuario lo cambie explícitamente. Referencias genéricas como “las clases”, “precio”, “cuánto cuesta”, “horarios”, “ubicación”, “cuándo empieza” o “el curso” se resuelven contra el intensivo.',
        ...
        '- Una consulta lateral sobre regulares no cambia por sí sola el programa activo. Solo cambia a regulares cuando el usuario expresa una preferencia inequívoca, por ejemplo “quiero clases regulares”, “prefiero regulares” o “quiero la mensualidad”.',
