    ...
    <div class="card">
        ...
        <form id="formAlumno">
            ...
            <div class="grid">
                ...
                <div class="campo">
                    <label for="horario_preferido_id">Horario *</label>
                    <select
                    ...
                    >
                        ...
                        <?php foreach ($horarios as $horario): ?>
                            <option value="<?= htmlspecialchars($horario['id']) ?>">
                                <?= htmlspecialchars(substr($horario['hora_inicio'], 0, 5)) ?>
                                —
                                <?= htmlspecialchars(substr($horario['hora_fin'], 0, 5)) ?>
                            </option>
                        <?php endforeach; ?>
...
form.addEventListener('submit', async function(e) {
    ...
    const datos = {
        ...
        horario_preferido_id: document.getElementById('horario_preferido_id').value,
        plan_actual_id: document.getElementById('plan_actual_id').value,
