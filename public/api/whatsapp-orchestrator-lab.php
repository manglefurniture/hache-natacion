...
$pdo=hache_sharky_pdo();if(!$pdo instanceof PDO){error_log('[sharky-orchestrator] lab database unavailable; event ignored safely');exit;}$configured=sharky_lab_secret('WHATSAPP_PHONE_NUMBER_ID');
