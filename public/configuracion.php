...
<main class="wrap">
  ...
  <div class="panel">
    ...
    <div class="links"><a class="hache-relation-action" href="/horarios.php">Horarios</a><?php if ($admin): ?><a class="hache-relation-action" href="/sharky-admin.php">Sharky</a><a class="hache-relation-action" href="/prospectos.php">CRM de prospectos</a><a class="hache-relation-action" href="/sharky-learning.php">Aprendizaje Sharky</a><a class="hache-relation-action" href="/sharky-positive-patterns.php">Patrones Sharky</a><a class="hache-relation-action" href="/profesores.php">Profesores</a><a class="hache-relation-action" href="/usuarios.php">Usuarios</a><?php endif; ?></div>
  </div>
  <div class="panel">
    <h3>Planes</h3>
    <div id="planes"></div>
