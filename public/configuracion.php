...
<main class="wrap">
  ...
  <div class="panel">
    ...
    <div class="links"><a class="hache-relation-action" href="/horarios.php">Horarios</a><a class="hache-relation-action" href="/sharky-admin.php">Sharky</a><?php if ($admin): ?><a class="hache-relation-action" href="/usuarios.php">Usuarios</a><?php endif; ?></div>
  </div>
  <div class="panel">
    <h3>Planes</h3>
    <div id="planes"></div>
