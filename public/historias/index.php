...
<head>
  ...
  <title>Historias Hache | Personas reales que aprendieron a nadar</title>
  <meta name="description" content="Historias reales de alumnos de Hache Natación en Cancún: confianza, constancia y el proceso de aprender a nadar siendo adulto.">
  <meta name="robots" content="index,follow,max-image-preview:large,max-snippet:-1">
  <link rel="canonical" href="https://hnatacion.com/historias/">
  ...
  <script type="application/ld+json">
  {
    ...
    "@graph":[
      {
        "@type":"CollectionPage",
        "@id":"https://hnatacion.com/historias/#page",
        "url":"https://hnatacion.com/historias/",
        "name":"Historias Hache",
        "description":"Historias reales de alumnos de Hache Natación en Cancún.",
        "inLanguage":"es-MX",
        "isPartOf":{"@type":"WebSite","@id":"https://hnatacion.com/#website"}
      },
      {
        "@type":"ItemList",
        "name":"Historias Hache",
      ...
      },
      {
        ...
        "itemListElement":[
          ...
          {"@type":"ListItem","position":2,"name":"Historias Hache","item":"https://hnatacion.com/historias/"}
        ]
      }
    ]
  }
...
<body class="historias-hub">
  <nav class="hub-nav" aria-label="Navegación de Historias Hache">
    <a class="hub-brand" href="/" aria-label="Hache Natación, inicio"><span class="hub-mark">H</span><span>H NATACIÓN</span></a>
    <a class="hub-back" href="/">Volver al sitio</a>
  </nav>
  <header class="hub-hero">
    <div class="hub-hero-inner">
      <p class="hub-kicker">HISTORIAS HACHE · CANCÚN</p>
      <h1>Personas reales.<br>Procesos reales.</h1>
      <p>Aprender a nadar no se ve igual para todos. Aquí contamos las historias de quienes decidieron comenzar, volver a intentarlo o descubrir hasta dónde podían llegar.</p>
    </div>
  </header>
